...
func NewLocationController(s *mgo.Session, databasename string) *LocationController {
	return &LocationController{dbname: databasename, session: s, tablename: "posts"}
}

func (c LocationController) GetLocationFromDB(id string) (user models.User, err error) {
	u := models.User{}
